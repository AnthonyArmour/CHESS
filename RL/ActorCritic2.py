...
class ActorCritic():
    ...
    def __init__(self, action_space, lr=0.0001, paths=None, convL=4, fcL=(2, 2048), filters=[32, 64, 64, 64],
        ...
        self.Actor, self.Critic = self.GetModel(paths=paths)
    ...
    def GetModel(self, paths=None):
        if paths is None:
            ...
            actor = k.models.load_model(paths["actor"])
